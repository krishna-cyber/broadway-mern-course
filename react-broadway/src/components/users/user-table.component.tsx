import {
  ...
  import { useFetchBannersForTable, useFetchUsers } from "../../services/queries/queries";
        ...
        <Table hoverable striped>
          ...
          <Table.Body className="divide-y">
            {usersDataForTable.isLoading ? (
              ...
              <>
                {usersDataForTable.data?.result && usersDataForTable.data?.result.length > 0 ? (
                  usersDataForTable.data?.result.map((data: any, index: number) => (
                    <Table.Row
                      key={index}
